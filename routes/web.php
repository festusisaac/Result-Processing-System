...
Route::middleware(['auth', 'active.session'])->group(function () {
    ...
    // Settings (profile only for non-admins)
    ...
    Route::middleware(['role:admin'])->group(function () {
        ...
        // Student create/delete (admin only)
        ...
        // Result Management (batches) - Moved to Admin Only
    ...
    Route::middleware(['role:admin,teacher'])->group(function () {
        // Student management (view, edit, promote - no create/delete for teachers)
        ...
        Route::patch('/students/{student}', [StudentController::class, 'update']); // Alternative update method
