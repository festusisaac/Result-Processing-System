...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="py-6">
        <h1 class="text-2xl font-semibold text-gray-900">Add Student</h1>
    </div>
    ...
    <div class="bg-white shadow sm:rounded-lg p-6">
        <form action="{{ route('students.store') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input name="adm_no" value="{{ old('adm_no') }}" required class="mt-1 block w-full rounded-md border-gray-300 p-2" />
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700">Full name</label>
                <input name="full_name" value="{{ old('full_name') }}" required class="mt-1 block w-full rounded-md border-gray-300 p-2" />
            </div>
            ...
            <div>
                ...
                <input type="date" name="dob" value="{{ old('dob') }}" class="mt-1 block w-full rounded-md border-gray-300 p-2" />
            </div>
            ...
            <div class="pt-4">
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded">Create student</button>
