    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <form action="{{ route('subjects.store') }}" method="POST" class="space-y-6 p-6">
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" id="submit-btn" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                    Create Subject
                </button>
            </div>
        </form>
